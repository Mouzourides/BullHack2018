...
var returnOfCreateQuizActions = Object.values(__assign({}, RentActions)).map(getReturnOfExpression);
export function RentReducer(state, action) {
    if (state === void 0) { state = initState; }
    switch (action.type) {
        case getType(RentActions.updateName): {
