...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Provider__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_connectAdvanced__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__connect_connect__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hoist_non_react_statics__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_Subscription__ = __webpack_require__(33);
...
const reselect_1 = __webpack_require__(55);
exports.defaultState = {
    greeting: 'Hello world',
    name: 'Nik Mouzourides',
};
function getFromState(state) {
    return state.user;
}
exports.getUser = reselect_1.createSelector([getFromState], (c) => c);
...
Object.defineProperty(exports, "__esModule", { value: true });
const typesafe_actions_1 = __webpack_require__(22);
exports.quizActions = {
    greetingUpdated: typesafe_actions_1.createAction('GREETING_UPDATED', (value) => ({
        payload: value,
        type: 'GREETING_UPDATED',
    })),
    nameUpdated: typesafe_actions_1.createAction('NAME_UPDATED', (value) => ({
        payload: value,
        type: 'NAME_UPDATED',
    })),
};
const returnOfQuizActions = Object.values(exports.quizActions).map(typesafe_actions_1.getReturnOfExpression);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__type_utils__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__get_type__ = __webpack_require__(57);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__is_action_of__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__create_action__ = __webpack_require__(59);
...
const Hello_1 = __webpack_require__(25);
const Store_1 = __webpack_require__(60);
...
const React = __webpack_require__(1);
const react_redux_1 = __webpack_require__(9);
const QuizAppState_1 = __webpack_require__(20);
const Quiz_1 = __webpack_require__(21);
const Hello = (props) => {
    const { user, } = props;
...
function mapStateToProps(state) {
    return {
        user: QuizAppState_1.getUser(state),
    };
}
function mapDispatchToProps(dispatch) {
    return {
        greetingUpdated: (value) => dispatch(Quiz_1.quizActions.nameUpdated(value)),
        nameUpdated: (value) => dispatch(Quiz_1.quizActions.greetingUpdated(value)),
    };
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_shallowEqual__ = __webpack_require__(35);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(8), __webpack_require__(46)(module)))
...
const Reducers_1 = __webpack_require__(61);
const redux_logger_1 = __webpack_require__(63);
...
Object.defineProperty(exports, "__esModule", { value: true });
const redux_1 = __webpack_require__(6);
const QuizReducer_1 = __webpack_require__(62);
exports.rootReducer = redux_1.combineReducers({
    QuizReducer: QuizReducer_1.quizReducer,
});
...
const QuizAppState_1 = __webpack_require__(20);
const typesafe_actions_1 = __webpack_require__(22);
function quizReducer(state = QuizAppState_1.defaultState, action) {
    switch (action.type) {
        case typesafe_actions_1.getType(Quiz_1.quizActions.greetingUpdated): {
            return Object.assign({}, state, { greeting: action.payload });
        }
        case typesafe_actions_1.getType(Quiz_1.quizActions.nameUpdated): {
